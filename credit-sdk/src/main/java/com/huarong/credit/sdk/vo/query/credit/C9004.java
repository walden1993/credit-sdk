...
package com.huarong.credit.sdk.vo.query.credit;
...
public class C9004 extends BaseC9000VO {
	...
	private String queyCardNo;// 被查询人银行卡号

	private String queryPhone;// 查询手机号

	private String authIndexId;// 合作机构实名认证记录索引编号

	private String authTime;

	private String veriFaceTime;

	private String idCardFile;

	private String otherAuthFile;

...
import com.huarong.credit.sdk.vo.query.credit.C9003;
...
public class CreditQueryTest {
	...
	public void C9002() {
		...
		c9002.setCertFile(Base64.encode(FileUtil.file("F:\\certs\\test\\face_1119121314124595221977.jpg")));
		c9002.setOtherFile("2222");
		c9002.setIncomeFile("3333");

		c9002.setAuthoFile(Base64.encode(FileUtil.file("F:\\certs\\test\\face_1119121314124595221977.jpg")));
		c9002.setWorkFile("");
	...
	public void C9004() {
		...
		c9004.setIdCardFile(Base64.encode(FileUtil.newFile("F:\\test\\demo-htmlfile.pdf")));
		c9004.setOtherAuthFile(Base64.encode(FileUtil.newFile("F:\\test\\demo-htmlfile.pdf")));
		c9004.setCaFile(Base64.encode(FileUtil.newFile("F:\\test\\demo-htmlfile.pdf")));
		c9004.setIdentFile(Base64.encode(FileUtil.newFile("F:\\test\\demo-htmlfile.pdf")));
		c9004.setWorkFile(Base64.encode(FileUtil.newFile("F:\\test\\demo-htmlfile.pdf")));
		c9004.setQueryDate(DateUtil.format(new Date(), "yyyyMMdd"));
		c9004.setOtherFile(Base64.encode(FileUtil.newFile("F:\\test\\demo-htmlfile.pdf")));
		c9004.setIncomeFile(Base64.encode(FileUtil.newFile("F:\\test\\demo-htmlfile.pdf")));
	...
	public void R9002() {
		...
		quleQueryVO.setSerialNumber("2020111804471300000354");
	...
	public void R9003() {
		...
		quleQueryVO.setRules(SecureUtil.des(desKey.getBytes()).encryptBase64(
				"R0001|R0002|R0003|R0004|R0005|R0006|R0007|R0008|R0009|R0010|R0011|R0012|R0013|R0014|R0015|R0016|R0017|R0018|R0019|R0020|R0021|R0022"));

		quleQueryVO.setSerialNumber("2020111805051500000913");
	...
	public void R9004() {
		...
		riskRptQueryVO.setSerialNumber("2020110308582600000751");
		...
		if ("0000".equals(jsonObject.getStr("code"))) {
			...
			if (verify) {
				...
				String htmlRpt = SecureUtil.rsa(privateKeyBase64, publicKeyBase64).decryptStr(data.getStr("htmlRpt"),
						KeyType.PrivateKey);
				FileUtil.writeBytes(htmlRpt.getBytes(), "F://test//test.html");
			}
		}
		System.out.println(result);
